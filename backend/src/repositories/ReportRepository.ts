...
export class ReportRepository extends BaseRepository {
  ...
  async findAllPaginated(options: {
    ...
    try {
      if (this.repository) {
        let queryBuilder = this.repository.createQueryBuilder('report');
        
        // Adicione condições de pesquisa específicas para esta entidade
        if (search) {
          queryBuilder = queryBuilder
            .where('report.name ILIKE :search', { search: `%${search}%` });
        }
      ...
      console.error(`Erro ao buscar registros de report:`, error);
      throw error;
    }
  }
  ...
  async findById(id: number): Promise<any | null> {
    try {
      ...
      console.error(`Erro ao buscar registro por ID em report:`, error);
      throw error;
    }
  }
  ...
  async create(data: any): Promise<any> {
    try {
      ...
      const query = `
        INSERT INTO report (${fields.join(', ')})
        VALUES (${placeholders})
        RETURNING *
      `;
      ...
      console.error(`Erro ao criar registro em report:`, error);
      throw error;
    }
  }
  ...
  async update(id: number, data: any): Promise<any | null> {
    try {
      ...
      console.error(`Erro ao atualizar registro em report:`, error);
      throw error;
    }
  }
  ...
  async delete(id: number): Promise<boolean> {
    try {
      ...
      console.error(`Erro ao deletar registro em report:`, error);
      throw error;
    }
  }
}
