...
export class RolesRepository extends BaseRepository {
  ...
  async findAllPaginated(options: {
    ...
    try {
      if (this.repository) {
        let queryBuilder = this.repository.createQueryBuilder('roles');
        
        // Adicione condições de pesquisa específicas para esta entidade
        if (search) {
          queryBuilder = queryBuilder
            .where('roles.name ILIKE :search', { search: `%${search}%` });
        }
      ...
      console.error(`Erro ao buscar registros de roles:`, error);
      throw error;
    }
  }
  ...
  async findById(id: number): Promise<any | null> {
    try {
      ...
      console.error(`Erro ao buscar registro por ID em roles:`, error);
      throw error;
    }
  }
  ...
  async create(data: any): Promise<any> {
    try {
      ...
      console.error(`Erro ao criar registro em roles:`, error);
      throw error;
    }
  }
  ...
  async update(id: number, data: any): Promise<any | null> {
    try {
      ...
      console.error(`Erro ao atualizar registro em roles:`, error);
      throw error;
    }
  }
  ...
  async delete(id: number): Promise<boolean> {
    try {
      ...
      console.error(`Erro ao deletar registro em roles:`, error);
      throw error;
    }
  }
}
