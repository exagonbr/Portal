...
const mediaEntryRepository = new MediaEntryRepository();
...
class MediaEntryController extends BaseController<MediaEntry> {
    ...
    async toggleStatus(req: Request, res: Response) {
        try {
            const { id } = req.params;
            const mediaEntry = await mediaEntryRepository.toggleStatus(id);
            if (!mediaEntry) {
    ...
    async search(req: Request, res: Response) {
        try {
            ...
            const mediaEntries = await mediaEntryRepository.search(q as string);
    ...
    async getActive(req: Request, res: Response) {
        try {
            const mediaEntries = await mediaEntryRepository.findActive();
            return res.status(200).json({ success: true, data: mediaEntries });
        } catch (error) {
    ...
    async getFeatured(req: Request, res: Response) {
        try {
            const mediaEntries = await mediaEntryRepository.findFeatured();
            return res.status(200).json({ success: true, data: mediaEntries });
        } catch (error) {
    ...
    async getPopular(req: Request, res: Response) {
        try {
            const mediaEntries = await mediaEntryRepository.findPopular();
            return res.status(200).json({ success: true, data: mediaEntries });
        } catch (error) {
    ...
    async getNew(req: Request, res: Response) {
        try {
            const mediaEntries = await mediaEntryRepository.findNew();
            return res.status(200).json({ success: true, data: mediaEntries });
        } catch (error) {
    ...
    async getRecommended(req: Request, res: Response) {
        try {
            const mediaEntries = await mediaEntryRepository.findRecommended();
            return res.status(200).json({ success: true, data: mediaEntries });
        } catch (error) {
    ...
    async getByAuthor(req: Request, res: Response) {
        try {
            ...
            const mediaEntries = await mediaEntryRepository.findByAuthor(parseInt(authorId));
            return res.status(200).json({ success: true, data: mediaEntries });
        } catch (error) {
    ...
    async getByPublisher(req: Request, res: Response) {
        try {
            ...
            const mediaEntries = await mediaEntryRepository.findByPublisher(parseInt(publisherId));
            return res.status(200).json({ success: true, data: mediaEntries });
        } catch (error) {
    ...
    async getByGenre(req: Request, res: Response) {
        try {
            ...
            const mediaEntries = await mediaEntryRepository.findByGenre(parseInt(genreId));
            return res.status(200).json({ success: true, data: mediaEntries });
        } catch (error) {
    ...
    async getBySubject(req: Request, res: Response) {
        try {
            ...
            const mediaEntries = await mediaEntryRepository.findBySubject(parseInt(subjectId));
            return res.status(200).json({ success: true, data: mediaEntries });
        } catch (error) {
    ...
    async incrementViews(req: Request, res: Response) {
        try {
            const { id } = req.params;
            await mediaEntryRepository.incrementViews(id);
    ...
    async softDelete(req: Request, res: Response) {
        try {
            const { id } = req.params;
            const success = await mediaEntryRepository.softDelete(id);
