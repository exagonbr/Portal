...
# Portal Sabercon - Otimização Nginx para Comunicação Direta
# Remove sobrecarga de proxy do Next.js e otimiza comunicação frontend-backend
...
log "🚀 Iniciando otimização do Nginx para comunicação direta..."
...
server {
    ...
    # ssl_certificate e ssl_certificate_key serão adicionados automaticamente
    ...
    location /_health {
        access_log off;
        return 200 "OK - Portal Sabercon Otimizado";
...
log "   3. Teste a aplicação: https://$DOMAIN"
