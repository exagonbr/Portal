...
export class GroupRepository {
  ...
  async getGroupStats(): Promise<{
    ...
    return {
      total_groups: parseInt(String(stats.total_groups)) || 0,
      active_groups: parseInt(String(stats.active_groups)) || 0,
      total_members: parseInt(String(stats.total_members)) || 0,
      permissions_count: parseInt(String(permissionsCount?.count || 0)) || 0
    };
  }
