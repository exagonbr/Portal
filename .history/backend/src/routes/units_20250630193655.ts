...
// Helper para padronizar formato de resposta
const formatApiResponse = (success: boolean, data?: any, message?: string, error?: string) => {
...
const formatUnit = (unit: any) => ({
  id: unit.id,
  name: unit.name,
  description: unit.description || '', // Campo pode não existir na tabela atual
  type: unit.type || 'school', // Valor padrão já que pode não existir na tabela
