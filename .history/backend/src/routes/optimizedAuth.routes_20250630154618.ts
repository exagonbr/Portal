 ...
 */
router.get('/profile', (req, res, next) => optimizedAuthMiddleware(req as any, res, next), OptimizedAuthController.getProfile);
 ...
 *         description: Token inválido ou expirado
 */
router.get('/validate', (req, res, next) => optimizedAuthMiddleware(req as any, res, next), OptimizedAuthController.validateToken);
 ...
 *         description: Token inválido ou expirado
 */
router.get('/permission/:permission', (req, res, next) => optimizedAuthMiddleware(req as any, res, next), OptimizedAuthController.hasPermission);
 ...
 */
router.post('/logout', (req, res, next) => optimizedAuthMiddleware(req as any, res, next), OptimizedAuthController.logout);
