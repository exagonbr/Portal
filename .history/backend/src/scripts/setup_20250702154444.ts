...
async function createDefaultData() {
  ...
  try {
    ...
    // Adicionando os métodos ao AuthService
    if (!AuthService.createDefaultRoles) {
      AuthService.createDefaultRoles = async function() {
        console.log('Implementação temporária de createDefaultRoles');
        // Implementação temporária
        return Promise.resolve();
      };
    }
    
    if (!AuthService.createDefaultAdminUser) {
      AuthService.createDefaultAdminUser = async function() {
        console.log('Implementação temporária de createDefaultAdminUser');
        // Implementação temporária
        return Promise.resolve();
      };
    }
