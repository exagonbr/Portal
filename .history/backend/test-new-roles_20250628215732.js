async function testNewRoles() {
  ...
  // Teste 1: Verificar se os novos campos existem no banco
  ...
  try {
    ...
    if (columns.rows.length !== 3) {
      console.log('❌ Nem todos os campos foram encontrados!');
      return;
    }
  ...
  // Teste 2: Simular usuários com diferentes roles
  console.log('\n📋 2. Simulando validação de permissões...');
