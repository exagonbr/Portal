...
const nextConfig = {
  ...
  async headers() {
    ...
    // Cache específico apenas para dados de sessão/auth - SEM CACHE
    ...
    // Cache para páginas - CACHE NORMAL
    ...
    return [
      // Cache para páginas HTML (exceto APIs)
      {
