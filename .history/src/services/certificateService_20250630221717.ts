...
export class CertificateService {
   ...
   */
  static async getCertificatesByUser(userId: number, filters: Partial<CertificateFilters> = {}): Promise<CertificateListResponse> {
   ...
   */
  static async getCertificatesByTvShow(tvShowId: number, filters: Partial<CertificateFilters> = {}): Promise<CertificateListResponse> {
   ...
   */
  static async getCertificatesWithMinScore(minScore: number, filters: Partial<CertificateFilters> = {}): Promise<CertificateListResponse> {
   ...
   */
  static async getRecreatableCertificates(filters: Partial<CertificateFilters> = {}): Promise<CertificateListResponse> {
