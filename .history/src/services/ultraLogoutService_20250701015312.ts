...
export class UltraLogoutService {
  ...
  /**
   * Mostra loading durante logout com efeito blur sem fundo
   */
  private static showLogoutLoading(): void {
    try {
      if (typeof document !== 'undefined') {
        // Criar overlay de loading apenas com blur (sem fundo)
        ...
        overlay.innerHTML = `
          <div class="logout-glass-card">
            ...
            <div style="font-size: 20px; font-weight: 600; margin-bottom: 8px; text-shadow: 0 2px 4px rgba(0, 0, 0, 0.3);">
