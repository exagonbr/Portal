...
class UserService {
  ...
  async getStats(): Promise<UserStats> {
    try {
      ...
      const response = await fetchWithAuth(buildApiUrl(`${this.baseUrl}/stats`), {
        method: 'GET',
      });
  ...
  async getUsers(filters: UserFilters = {}): Promise<PaginatedResponse<User>> {
    try {
      ...
      const response = await fetchWithAuth(buildApiUrl(`${this.baseUrl}?${params.toString()}`), {
        method: 'GET',
      });
  ...
  async getUserById(id: string | number): Promise<User> {
    try {
      ...
      const response = await fetchWithAuth(buildApiUrl(`${this.baseUrl}/${id}`), {
        method: 'GET',
      });
  ...
  async getCurrentUser(): Promise<User> {
    try {
      ...
      const response = await fetchWithAuth(buildApiUrl(`${this.baseUrl}/me`), {
        method: 'GET',
      });
  ...
  async createUser(data: CreateUserData): Promise<User> {
    try {
      ...
      const response = await fetchWithAuth(buildApiUrl(this.baseUrl), {
        method: 'POST',
        body: JSON.stringify(data)
      });
  ...
  async activateUser(id: string | number): Promise<void> {
    try {
      ...
      const response = await fetchWithAuth(buildApiUrl(`${this.baseUrl}/${id}/activate`), {
        method: 'POST',
      });
  ...
  async deactivateUser(id: string | number): Promise<void> {
    try {
      ...
      const response = await fetchWithAuth(buildApiUrl(`${this.baseUrl}/${id}/deactivate`), {
        method: 'POST',
      });
  ...
  async resetPassword(id: string | number): Promise<void> {
    try {
      ...
      const response = await fetchWithAuth(buildApiUrl(`${this.baseUrl}/${id}/reset-password`), {
        method: 'POST',
      });
  ...
  async searchUsers(query: string, filters: Partial<UserFilters> = {}): Promise<PaginatedResponse<User>> {
    try {
      ...
      const response = await fetchWithAuth(buildApiUrl(`${this.baseUrl}/search?${params.toString()}`), {
        method: 'GET',
      });
  ...
  async getUsersByRole(roleId: string): Promise<User[]> {
    try {
      ...
      const response = await fetchWithAuth(buildApiUrl(`${this.baseUrl}/role/${roleId}`), {
        method: 'GET',
      });
  ...
  async getUsersByInstitution(institutionId: number): Promise<User[]> {
    try {
      ...
      const response = await fetchWithAuth(buildApiUrl(`${this.baseUrl}/institution/${institutionId}`), {
        method: 'GET',
      });
