...
export default function TVShowsManagePage() {
  ...
  const createTVShow = async (): Promise<boolean> => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:3001/api/tv-shows', {
        method: 'POST',
  ...
  const updateTVShow = async (): Promise<boolean> => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/tv-shows/${selectedTvShow.id}`, {
        method: 'PUT',
        headers: { 'Authorization': `Bearer ${token}` },
        body: formData
      })
  ...
  const deleteTVShow = async (id: number): Promise<boolean> => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/tv-shows/${id}`, {
        method: 'DELETE',
        headers: { 
  ...
  const uploadFile = async (file: File, folder: string = 'tv-shows'): Promise<string | null> => {
    try {
      ...
      const response = await fetch('http://localhost:3001/api/aws/upload', {
        method: 'POST',
        body: formData
      })
  ...
  const loadTvShows = async (page = 1, search = '') => {
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/tv-shows?${params}`, {
        headers
      })
  ...
  const calculateStats = async () => {
    try {
      ...
      const response = await fetch('http://localhost:3001/api/tv-shows?page=1&limit=10000', { headers })
  ...
  const loadTvShowDetails = async (id: number) => {
    try {
      ...
      const response = await fetch(`http://localhost:3001/api/tv-shows/${id}`, { headers })
      if (response.ok) {
        const data = await response.json()
        if (data.success) {
