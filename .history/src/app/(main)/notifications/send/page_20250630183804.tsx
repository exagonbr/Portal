    ...
    const loadTemplates = async () => {
      try {
        ...
        if (response.success && response.data) {
          ...
          console.log(`✅ [TEMPLATES] ${response.data.length} templates carregados`)
        } else {
        ...
        <div className="mb-6">
          <div className="border-b border-gray-200">
            <nav className="-mb-px flex space-x-8">
              ...
              >
                <span className="flex items-center gap-2">
                  <span className="material-symbols-outlined text-sm">template</span>
                  Templates de Email
                </span>
              </button>
            </nav>
      ...
      {templates.length === 0 ? (
        <div className="text-center py-12">
          <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <span className="material-symbols-outlined text-2xl text-gray-400">template</span>
          </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-3">
                        <div className="content-card-icon-wrapper bg-purple-500">
                          <span className="material-symbols-outlined content-card-icon">template</span>
                        </div>
                        <div>
