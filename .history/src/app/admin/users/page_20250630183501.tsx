...
export default function AdminUsersPage() {
  ...
  const columns: CRUDColumn<UsersResponseDto>[] = [
    ...
    },
    {
      ...
      width: '120px',
      render: (_, user) => {
        const roleName = user.roleName || 'Não definida'
        return (
    ...
    },
    {
      ...
      width: '150px',
      render: (_, user) => {
        const institutionName = user.institutionName || 'Não vinculada'
        return (
      ...
      render: (_, user) => {
        ...
        return (
          <div className="flex items-center gap-1">
            ...
            <span className="text-xs font-medium text-slate-700" title={formatDate(user.createdAt)}>
              {formattedDate}
            </span>
          </div>
        )
