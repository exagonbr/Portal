...
export default function ManagementLayout({
  ...
  useEffect(() => {
    ...
    const allowedRoles = ['SYSTEM_ADMIN', 'INSTITUTION_MANAGER', 'SCHOOL_MANAGER'];
  ...
  if (!session || !['SYSTEM_ADMIN', 'INSTITUTION_MANAGER', 'SCHOOL_MANAGER'].includes(session.user?.role || '')) {
    return null;
  }
