...
const LicenseValidationModal: React.FC<LicenseValidationModalProps> = ({
  ...
  const CertificatesListModal = () => (
    <div className="flex inset-0 bg-black bg-opacity-50 flex items-center justify-center z-60 p-1 xs:p-2 sm:p-3 lg:p-4">
      <div className=" w-200 h-200 bg-white rounded-lg shadow-xl w-full max-w-[98vw] xs:max-w-[96vw] sm:max-w-[95vw] md:max-w-[90vw] lg:max-w-7xl xl:max-w-[85vw] 2xl:max-w-[80vw] max-h-[98vh] xs:max-h-[96vh] sm:max-h-[94vh] md:max-h-[92vh] lg:max-h-[90vh] overflow-hidden mx-1 xs:mx-2 sm:mx-3 lg:mx-4">
        {/* Header */}
          ...
          <div className="space-y-3 xs:space-y-4 sm:space-y-5 lg:space-y-6">
            {certificates.map((cert) => (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3 xs:gap-4 sm:gap-5 lg:gap-6 mb-4 xs:mb-5 sm:mb-6">
