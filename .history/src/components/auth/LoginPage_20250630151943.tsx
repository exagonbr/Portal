    ...
    >
      ...
      >
        ...
        <div className="relative flex py-2 items-center">
          <div className="flex-grow border-t" style={{ borderColor: theme.colors.border.DEFAULT }}></div>
          <span className="flex-shrink mx-4 text-xs" style={{ color: theme.colors.text.secondary }}>OU</span>
          <div className="flex-grow border-t" style={{ borderColor: theme.colors.border.DEFAULT }}></div>
        </div>
