  ...
  useEffect(() => {
    if (authUser) {
      console.log('🔐 Verificando permissões do usuário:', {
        ...
        canCreateUsers: ['SYSTEM_ADMIN', 'INSTITUTION_MANAGER', 'SCHOOL_MANAGER', 'admin'].includes(authUser.role?.toUpperCase() || '')
      })
    }
  }, [authUser])
    ...
    <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="bg-slate-50 p-4 rounded-lg">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                {['SYSTEM_ADMIN', 'INSTITUTION_MANAGER', 'SCHOOL_MANAGER', 'admin'].includes(authUser.role?.toUpperCase() || '') ? (
        ...
        <div className="flex justify-end gap-3 pt-4 border-t border-slate-200">
          ...
          <button
            type="submit"
            disabled={isLoading || !authUser || !['SYSTEM_ADMIN', 'INSTITUTION_MANAGER', 'SCHOOL_MANAGER', 'admin'].includes(authUser?.role?.toUpperCase() || '')}
