...
export const mockBooks: Book[] = [
  ...
  // Livros em EPUB - Literatura Internacional e Técnicos
  {
    ...
    duration: '6h 00min',
    format: 'epub',
    filePath: 'https://www.gutenberg.org/ebooks/1342.epub3.images',
    pageCount: 432,
    progress: 60,
    language: 'en',
  ...
  },
  {
    ...
    duration: '5h 30min',
    format: 'epub',
    filePath: 'https://www.gutenberg.org/ebooks/84.epub3.images',
    pageCount: 280,
    progress: 0,
    language: 'en',
  ...
  },
  {
    ...
    duration: '2h 30min',
    format: 'epub',
    filePath: 'https://www.gutenberg.org/ebooks/11.epub3.images',
    pageCount: 150,
    progress: 80,
    language: 'en',
  ...
  },
  {
    ...
    duration: '4h 00min',
    format: 'epub',
    filePath: 'https://www.gutenberg.org/ebooks/1661.epub3.images',
    pageCount: 320,
    progress: 35,
    language: 'en',
  ...
  },
  {
    ...
    duration: '8h 00min',
    format: 'epub',
    filePath: 'https://www.gutenberg.org/ebooks/2701.epub3.images',
    pageCount: 635,
    progress: 15,
    language: 'en',
  ...
  },
  {
    ...
    duration: '2h 00min',
    format: 'epub',
    filePath: 'https://www.gutenberg.org/ebooks/46.epub3.images',
    pageCount: 110,
    progress: 100,
    language: 'en',
  ...
  },
  {
    ...
    duration: '4h 30min',
    format: 'epub',
    filePath: 'https://www.gutenberg.org/ebooks/74.epub3.images',
    pageCount: 260,
    progress: 50,
    language: 'en',
  ...
  },
  {
    ...
    duration: '6h 30min',
    format: 'epub',
    filePath: 'https://www.gutenberg.org/ebooks/345.epub3.images',
    pageCount: 420,
    progress: 20,
    language: 'en',
  ...
  {
    id: 'pdf-tech-3',
    thumbnail: 'https://automatetheboringstuff.com/images/automate2_cover.png',
