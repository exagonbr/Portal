...
export default function VideosPage() {
  ...
  return (
    <div className="p-6 space-y-10  min-h-screen text-black">
      <h1 className="text-4xl font-bold mb-6">Portal de Vídeos</h1>
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-4">Continue Assistindo</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-4">Sugestões para Você</h2>
        <Carousel settings={carouselSettings}>
