      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="text-lg font-bold text-gray-800">20/03/2024</div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="text-lg font-bold text-gray-800">21/03/2024</div>
            <div className="text-sm text-blue-600 mt-1">02:00</div>
          </div>
          
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="text-sm font-medium text-gray-500 mb-1">Espaço Usado</div>
            <div className="text-lg font-bold text-gray-800">8.4 GB</div>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              <th className="text-left py-3 px-6 font-medium text-gray-700">Nome</th>
          ...
          <tbody>
            {MOCK_BACKUPS.map((backup) => (
              <tr key={backup.id} className="border-b border-gray-100 hover:bg-gray-50">
                <td className="py-4 px-6 font-medium text-gray-800">{backup.name}</td>
                <td className="py-4 px-6">
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    backup.type === 'Completo' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'
                  }`}>
                    {backup.type}
                  </span>
                </td>
