...
const LoadingFallback = () => (
  <div className="flex items-center justify-center min-h-screen">
    ...
    <span className="ml-2 text-gray-600">Carregando página de certificados...</span>
  </div>
)
...
const CertificatesPageContent = dynamic(
  () => import('./CertificatesPageContent').catch((error) => {
    console.error('Erro ao importar CertificatesPageContent:', error)
