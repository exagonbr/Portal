...
export default function AuthenticatedLayout({ children }: AuthenticatedLayoutProps) {
  ...
  const notifications = [
    { id: 1, title: 'Nova atividade disponível', message: 'Matemática - Lista de exercícios 3', time: '2h atrás', read: false, type: 'info' as const },
    { id: 2, title: 'Nota publicada', message: 'História - Prova do 2º bimestre', time: '4h atrás', read: false, type: 'success' as const },
    { id: 3, title: 'Reunião de pais', message: 'Agendada para 20/06 às 19h', time: '1d atrás', read: true, type: 'warning' as const }
  ]

  const activities = [
    { id: '1', type: 'assignment' as const, title: 'Matemática - Lista 3', description: 'Entrega até 15/06', time: '2h', priority: 'high' as const },
    { id: '2', type: 'grade' as const, title: 'Nota Publicada', description: 'História - Prova Bimestral', time: '4h', priority: 'medium' as const },
    { id: '3', type: 'message' as const, title: 'Nova Mensagem', description: 'Prof. Silva enviou uma mensagem', time: '1d', priority: 'low' as const }
  ]
