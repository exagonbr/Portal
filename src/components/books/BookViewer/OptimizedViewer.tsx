...
const OptimizedViewer: React.FC<OptimizedViewerProps> = ({
  ...
  // Efeito para calcular as dimensões do conteúdo com base no modo de ajuste
  useEffect(() => {
    const updateDimensions = () => {
      if (contentRef.current) {
        ...
        // Ajustar com base no modo de ajuste
        switch (fitMode) {
          case 'width':
            ...
            break;
          case 'height':
            // Ajustar à altura disponível
            height = clientHeight - 80; // Mais espaço para controles
            break;
          case 'page':
            // Ajustar à página inteira
            width = Math.min(width, height * 0.7); // Proporção típica de página
            break;
        }
  ...
  const renderBookContent = () => {
    ...
    if (book.format === 'pdf') {
      return (
        ...
        >
          <div className={`flex ${viewerState.isDualPage ? 'space-x-4' : ''} justify-center items-start h-full py-4 overflow-auto`}>
            {getPagesToDisplay().map((pageNum) => (
              ...
              >
                <Page
                  pageNumber={pageNum}
                  width={fitMode === 'width' ? contentDimensions.width : undefined}
                  height={fitMode === 'height' ? contentDimensions.height : undefined}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-3 py-2 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm flex-shrink-0">
            ...
            <div className="flex items-center bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
              ...
              <div className="flex items-center space-x-1 px-2">
                <input
                  ...
                  className="w-12 px-1 py-1 text-center bg-white dark:bg-gray-800 rounded border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 text-xs"
                  min={1}
                  max={numPages || 1}
                />
        ...
        <div className="flex items-center space-x-1">
          ...
          <div className="flex bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
            ...
            >
              ...
              <option value="page">Ajustar Página</option>
            </select>
          </div>
