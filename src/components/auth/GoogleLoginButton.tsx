  ...
  return (
    ...
    >
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg border shadow-sm text-sm font-medium transition-all duration-200 transform hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none hover:shadow-md"
        style={{
